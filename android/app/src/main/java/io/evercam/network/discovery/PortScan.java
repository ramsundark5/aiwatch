...
public class PortScan {
    ...
    /**
     * Scan the common ports that are frequently used by Evercam only when HTTP
     * port(80) or RTSP port(554) is not open
     */
    ...
    public ArrayList<Port> getActivePorts() throws EvercamException {
        if (activePortList != null) {
            ...
            throw new EvercamException(
                    EvercamException.MSG_PORT_SCAN_NOT_STARTED);
        }
    }
}
